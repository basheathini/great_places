...
import 'dart:convert';
const GOOGLE_API_KEY = 'AIzaSyAuUmG4Zimuzh0DD8rGh1vKEx2OVGox-1g';
...
class LocationHelper{
  ...
  static Future<String> getPlaceAddress(double latitude, double longitude) async {
    final String url = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=$latitude,$longitude&key=$GOOGLE_API_KEY';
